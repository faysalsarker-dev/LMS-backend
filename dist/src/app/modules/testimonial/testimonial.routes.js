...
const testimonialController = __importStar(require("./testimonial.controller"));
const CheckAuth_1 = require("../../middleware/CheckAuth");
const router = express_1.default.Router();
// ✅ Create testimonial
router.post("/", (0, CheckAuth_1.checkAuth)(), testimonialController.createTestimonial);
// ✅ Update testimonial
router.patch("/:testimonialId", (0, CheckAuth_1.checkAuth)(), testimonialController.updateTestimonial);
