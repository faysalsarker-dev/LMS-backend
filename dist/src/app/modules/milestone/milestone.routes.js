...
router.post("/", (0, validateRequest_middleware_1.default)(milestone_validation_1.createMilestoneSchema), milestoneController.createMilestone);
router.get("/", milestoneController.getAllMilestones);
router.get("/:id", milestoneController.getMilestone);
router.put("/:id", (0, validateRequest_middleware_1.default)(milestone_validation_1.updateMilestoneSchema), milestoneController.updateMilestone);
