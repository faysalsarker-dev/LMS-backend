...
const progressController = __importStar(require("./progress.controller"));
...
router.get("/certificate/:progressId", (0, CheckAuth_1.checkAuth)(), progressController.handleGenerateCertificate);
