...
router.post('/items', (0, CheckAuth_1.checkAuth)([auth_interface_1.UserRoles.ADMIN, auth_interface_1.UserRoles.SUPER_ADMIN, auth_interface_1.UserRoles.INSTRUCTOR]), (0, rateLimiter_1.rateLimit)('write'), (0, fileUpload_middleware_1.dynamicFileUploadMiddleware)(['audio', 'image']), practice_controller_1.PracticeController.addItemToPractice);
router.patch('/:practiceId/items/:itemId', (0, CheckAuth_1.checkAuth)([auth_interface_1.UserRoles.ADMIN, auth_interface_1.UserRoles.SUPER_ADMIN, auth_interface_1.UserRoles.INSTRUCTOR]), (0, rateLimiter_1.rateLimit)('write'), (0, fileUpload_middleware_1.dynamicFileUploadMiddleware)(['audio', 'image']), practice_controller_1.PracticeController.updatePracticeItem);
