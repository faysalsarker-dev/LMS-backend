    ...
    if (!submission) {
        ...
        incomingSections.forEach((incoming) => {
            ...
            if (existingSecIndex > -1) {
                ...
                studentAnswersArray.forEach((newAns) => {
                    const index = mergedAnswers.findIndex((ans) => ans.questionId === newAns.questionId);
                    if (index > -1) {
                ...
                existingSection.studentAnswers = mergedAnswers;
