...
const mockTestSection_interface_1 = require("../mockTestSection/mockTestSection.interface");
...
async function seedData() {
    ...
    try {
        ...
        const mockTest = await mockTest_model_1.default.create({
            title: "HSK 4 Full Mock Test - Demo",
            course: new mongoose_1.default.Types.ObjectId(COURSE_ID),
            status: "published",
        ...
        // 2. Listening Section
        const listeningSection = await mockTestSection_model_1.default.create({
            ...
            questions: [
                {
                    type: mockTestSection_interface_1.MockQuestionType.L_PICTURE_MATCHING,
                    marks: 2,
                ...
                {
                    type: mockTestSection_interface_1.MockQuestionType.L_AUDIO_MCQ,
                    marks: 3,
                ...
                {
                    type: mockTestSection_interface_1.MockQuestionType.L_LONG_DIALOGUE_MATCHING,
                    marks: 5,
        ...
        // 3. Reading Section
        const readingSection = await mockTestSection_model_1.default.create({
            mockTest: mockTest._id,
            name: "reading",
            timeLimit: 40,
            ...
            questions: [
                {
                    type: mockTestSection_interface_1.MockQuestionType.R_SENTENCE_TO_PICTURE,
                    marks: 2,
                ...
                {
                    type: mockTestSection_interface_1.MockQuestionType.R_FILL_IN_THE_GAP,
                    marks: 4,
                ...
                {
                    type: mockTestSection_interface_1.MockQuestionType.R_REARRANGE_PASSAGE,
                    marks: 5,
                ...
                {
                    type: mockTestSection_interface_1.MockQuestionType.R_PASSAGE_MCQ,
                    marks: 6,
        ...
        // 4. Writing Section
        const writingSection = await mockTestSection_model_1.default.create({
            mockTest: mockTest._id,
            name: "writing",
            timeLimit: 25,
            ...
            questions: [
                {
                    type: mockTestSection_interface_1.MockQuestionType.W_PICTURE_TO_WORD,
                    marks: 2,
                ...
                {
                    type: mockTestSection_interface_1.MockQuestionType.W_WORD_TO_SENTENCE,
                    marks: 3,
                ...
                {
                    type: mockTestSection_interface_1.MockQuestionType.W_PINYIN_TO_CHARACTER,
                    marks: 2,
                ...
                {
                    type: mockTestSection_interface_1.MockQuestionType.W_COMPOSITION_PICTURES,
                    marks: 10,
                ...
                {
                    type: mockTestSection_interface_1.MockQuestionType.W_COMPOSITION_TOPIC,
                    marks: 15,
        ...
        // 5. Speaking Section
        const speakingSection = await mockTestSection_model_1.default.create({
            mockTest: mockTest._id,
            name: "speaking",
            timeLimit: 15,
            ...
            questions: [
                {
                    type: mockTestSection_interface_1.MockQuestionType.S_REPEAT_AFTER_LISTENING,
                    marks: 5,
                ...
                {
                    type: mockTestSection_interface_1.MockQuestionType.S_SPEAK_ON_PICTURE,
                    marks: 10,
                ...
                {
                    type: mockTestSection_interface_1.MockQuestionType.S_ANSWER_QUESTION,
                    marks: 5,
        ...
        mockTest.listening = listeningSection._id;
        mockTest.reading = readingSection._id;
        mockTest.writing = writingSection._id;
        mockTest.speaking = speakingSection._id;
        await mockTest.save();
