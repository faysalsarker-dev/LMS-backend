...
function InviteEmail({ name, role, email, password, orgName = 'Your Company', loginUrl = 'https://your-app.example.com/login', primaryColor = '#6a45ff', backgroundColor = '#f7f7f7', textColor = '#252429', lightTextColor = '#646368' }) {
