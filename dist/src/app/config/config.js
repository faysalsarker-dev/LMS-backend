...
const envSchema = zod_1.z.object({
    ...
    BUNNY_STORAGE_ZONE_NAME: zod_1.z.string(),
    ...
    SSL_SUCCESS_FRONTEND_URL: zod_1.z.string(),
    SSL_CANCEL_FRONTEND_URL: zod_1.z.string(),
    SSL_SUCCESS_BACKEND_URL: zod_1.z.string(),
    SSL_CANCEL_BACKEND_URL: zod_1.z.string(),
    SSL_FAIL_BACKEND_URL: zod_1.z.string(),
    SSL_FAIL_FRONTEND_URL: zod_1.z.string(),
});
...
exports.default = {
    ...
    backend_url: env.data.BACKEND_URL,
    cloudinary: {
    ...
    ssl: {
        ...
        sslSuccessFrontendUrl: `${env.data.FRONTEND_URL}${env.data.SSL_SUCCESS_FRONTEND_URL}`,
        sslCancelFrontendUrl: `${env.data.FRONTEND_URL}${env.data.SSL_CANCEL_FRONTEND_URL}`,
        sslSuccessBackendUrl: `${env.data.BACKEND_URL}${env.data.SSL_SUCCESS_BACKEND_URL}`,
        sslCancelBackendUrl: `${env.data.BACKEND_URL}${env.data.SSL_CANCEL_BACKEND_URL}`,
        sslFailBackendUrl: `${env.data.BACKEND_URL}${env.data.SSL_FAIL_BACKEND_URL}`,
        sslFailedFrontendUrl: `${env.data.FRONTEND_URL}${env.data.SSL_FAIL_FRONTEND_URL}`,
    },
};
