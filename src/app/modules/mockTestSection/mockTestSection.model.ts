...
import {
  ...
  MockQuestionType,
  AUTO_MARKED_TYPES,
} from "./mockTestSection.interface";
...
mockQuestionSchema.pre("validate", function (next) {
  this.isAutoMarked = AUTO_MARKED_TYPES.has(this.type as MockQuestionType);
  next();
});
...
const MockTestSection = mongoose.model<IMockTestSection>(
  "MockTestSection",
