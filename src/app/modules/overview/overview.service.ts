...
class OverviewService {
  ...
  async getCourseStats() {
    ...
    return {
      total: result.total[0]?.count || 0,
      status: {
        draft: result.byStatus.find((s: any) => s._id === "draft")?.count || 0,
        published: result.byStatus.find((s: any) => s._id === "published")?.count || 0,
        archived: result.byStatus.find((s: any) => s._id === "archived")?.count || 0,
      },
      levels: {
        beginner: result.byLevel.find((l: any) => l._id === "Beginner")?.count || 0,
        intermediate: result.byLevel.find((l: any) => l._id === "Intermediate")?.count || 0,
        advanced: result.byLevel.find((l: any) => l._id === "Advanced")?.count || 0,
      },
